        ...
        <div className="navBar-menu">
          ...
          <div className="navBar-menu-item">
            <div className="menu-item-title">
              ...
              <div className="sub-menu">
                ...
                <p className="sub-menu-item" onClick={() => navigate('/listExportSlip/Provider')}>Phiếu xuất kho</p>
              </div>
              <div className="sub-menu">
                <div className="sub-menu-item">
          ...
          <div className="navBar-menu-item">
            <div className="menu-item-title">
              ...
              <div className="sub-menu">
                <div className="sub-menu-item"> 
                  <p onClick={() => navigate('/listAgency')}><i className="fa-solid fa-chevron-right icon-navbar" ></i>Nguồn hàng xuất/nhập</p>
                  <p onClick={() => navigate('/listProduct')}><i className="fa-solid fa-chevron-right icon-navbar" ></i>Danh mục hàng hóa</p>
