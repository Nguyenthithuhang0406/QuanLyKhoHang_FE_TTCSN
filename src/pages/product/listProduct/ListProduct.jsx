            ...
            <div className="daulist">
              <div className="left-sec">
                <div className="itemleft">
                  ...
                  <input className="listproductinput" type="text" id="mhh" name="productCode" value={productCode} onChange={handleChange} />
                </div>
              </div>
              ...
              <div className="right-sec">
                <div className="itemleft" >
                  ...
                  <input className="listproductinput" type="text" id="thh" name="productName" value={productName} onChange={handleChange} />
                </div>
              </div>

              <button type="submit" className="tklistproduct" onClick={handleSearch}>Tìm kiếm</button>
            </div>
            <button className='addButtonthem' onClick={handleClickAdd}>Thêm hàng hoá</button>
