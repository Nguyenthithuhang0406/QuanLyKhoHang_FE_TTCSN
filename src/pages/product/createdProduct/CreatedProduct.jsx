    ...
    <div className="createProduct-container">
      ...
      <div className="createProduct">
        <div className="createProduct-nav">
          <p className='create-link' onClick={() => navigate('/listProduct')}>Quản lý danh mục hàng hóa</p>
          <i className="fa-solid fa-chevron-right" style={{ color: 'black', alignItems: 'center', fontSize: '15px' }}></i>
        ...
        <div className="createProduct-form">
          ...
          <div className="main-form">
            <div className="productInfor-row">
              ...
              <input type="text" name="productCode" className="createProduc-textbox" value={product.productCode} readOnly />
            </div>

            <div className="productInfor-row">
              <label htmlFor="productName" className="createProduct-lbl">Tên hàng</label>
              <input type="text" name="productName" className="createProduc-textbox" value={product.productName} onChange={handleChange} />
            </div>

            <div className="productInfor-row">
              <label htmlFor="productGroup" className="createProduct-lbl">Nhóm hàng</label>
              <input type="text" name="productGroup" className="createProduc-textbox" value={product.productGroup} onChange={handleChange} />
            </div>
                ...
                {files.length > 0 &&
                  files.map((file, index) => (
                    <div key={index} style={{ width: '100px', height: '100px', position: 'relative' }}>
                      ...
                      <i className="fa-sharp fa-solid fa-xmark" onClick={() => handleDeleteFile(index)} style={{ position: 'absolute', top: '11px', right: '-7px', zIndex: '10', color: 'darkgray' }}></i>
                    </div>
                  ))}
                <label >
            ...
            <div className="productInfor-column">
              ...
              <input type="text" name="productDVT" className="createProduc-textbox" value={product.productDVT} onChange={handleChange} />
            </div>

            <div className="productInfor-column">
              <label htmlFor="productUnit" className="createProduct-lbl">Giá</label>
              <input type="text" name="productPrice" className="createProduc-textbox" value={product.productPrice} onChange={handleChange} />
            </div>

            <div className="productInfor-column">
              <label htmlFor="productDescribe" className="createProduct-lbl">Mô tả hàng hóa</label>
              <textarea name="productDescription" className="createProduc-textbox bigTextbox" rows="10" cols="50" placeholder="Viết mô tả ở đây..." value={product.productDescription} onChange={handleChange}></textarea>
            </div>
